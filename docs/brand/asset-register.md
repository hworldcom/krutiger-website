...
| Instagram photography collection     | Candidate source       | [Official KRUTIGER Instagram account](https://www.instagram.com/krutigermuaythai/)                                   | Not imported                      | Public previews are compressed and unsuitable as production masters.                                             | The account is approved as a candidate source. Each photograph still requires its original file, photographer/rightsholder confirmation, and depicted-person consent. |
